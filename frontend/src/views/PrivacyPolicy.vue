...
<template>
  <LegalContainer>
    ...
    <h2>2. Speichern und Teilen von Prozessen</h2>
    <h3>Speichern</h3>
    <p>
      Wenn ein Workflow gespeichert wird, wird dieser im localStorage Ihres Browsers mit dem
      vergebenen Namen, den gewählten Bestandteilen und einer eindeutigen ID gespeichert. Der
      Betreiber hat keinen Zugriff auf diese Daten. Sie können die gespeicherten Workflows jederzeit
      löschen, indem Sie den entsprechenden Button "Alle löschen" auf der Übersichtsseite klicken
      oder die Daten in den Einstellungen Ihres Browsers löschen.
    </p>

    <h3>Teilen</h3>
    <p>
      Wenn ein Workflow geteilt wird, wird dieser mit dem vergebenen Namen und den gewählten
      Bestandteilen in einer Datenbank auf dem Server des Betreibers gespeichert, sodass der Prozess
      über einen Link abgerufen werden kann. Dabei wird diesem eine eindeutige ID zugewiesen, über
      die der Prozess abgerufen werden kann. Der Betreiber hat Zugriff auf diese Daten. Wenn ein
      Worklfow geteilt wurde, kann er nur unter Nennung der ID wieder vom Betreiber gelöscht werden.
    </p>
    ...
    <p>
      Nils Polarek<br />
      Bl&uuml;cherweg 30<br />
      58511 L&uuml;denscheid
    </p>

    <p>E-Mail: n.polarek@live.de</p>
    <p>
